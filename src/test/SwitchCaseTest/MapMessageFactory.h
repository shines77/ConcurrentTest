...
MAP_REGISTER_MESSAGE(CephMessage22, CEPH_MSG_ID_22);
MAP_REGISTER_MESSAGE(CephMessage23, CEPH_MSG_ID_23);
MAP_REGISTER_MESSAGE(CephMessage24, CEPH_MSG_ID_24);
MAP_REGISTER_MESSAGE(CephMessage25, CEPH_MSG_ID_25);
MAP_REGISTER_MESSAGE(CephMessage26, CEPH_MSG_ID_26);
MAP_REGISTER_MESSAGE(CephMessage27, CEPH_MSG_ID_27);
MAP_REGISTER_MESSAGE(CephMessage28, CEPH_MSG_ID_28);
MAP_REGISTER_MESSAGE(CephMessage29, CEPH_MSG_ID_29);

MAP_REGISTER_MESSAGE(CephMessage30, CEPH_MSG_ID_30);
MAP_REGISTER_MESSAGE(CephMessage31, CEPH_MSG_ID_31);
MAP_REGISTER_MESSAGE(CephMessage32, CEPH_MSG_ID_32);
MAP_REGISTER_MESSAGE(CephMessage33, CEPH_MSG_ID_33);
MAP_REGISTER_MESSAGE(CephMessage34, CEPH_MSG_ID_34);
MAP_REGISTER_MESSAGE(CephMessage35, CEPH_MSG_ID_35);
MAP_REGISTER_MESSAGE(CephMessage36, CEPH_MSG_ID_36);
MAP_REGISTER_MESSAGE(CephMessage37, CEPH_MSG_ID_37);
MAP_REGISTER_MESSAGE(CephMessage38, CEPH_MSG_ID_38);
MAP_REGISTER_MESSAGE(CephMessage39, CEPH_MSG_ID_39);
